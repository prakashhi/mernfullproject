...
const Menu = () => {
  ...
  const Data = [
    { Text: "Work Location Data", img: <FaMapLocationDot /> ,link:'/Admin_worklocationdata'},
    ...
    <>
      <div className="border bg-gray-100 absolute left-3 top-12 px-4 py-2 z-10 rounded-xl shadow-md">
        <div className="flex flex-col gap-2">
          {Data.map((val, index) => (
            <p className="flex gap-2 items-center cursor-pointer hover:bg-white px-2 rounded-md" key={index}>
              {val.img}
