                ...
                <div className='flex justify-center '>
                    ...
                    <div className='shadow-2xl backdrop-blur-sm bg-white/30 inline-grid max-[800px]:p-4 p-10 rounded w-[40%] max-[800px]:w-[95%] duration-[0.5s]'>
                        ...
                        <div id='btn' className='w-full flex justify-center m-2 text-center'>
                            <button onClick={submit} className='hover:px-9 hover:py-3 duration-[0.5s] px-7 py-2 text-white bg-fuchsia-600 rounded-full'>

                                {
                                    load == true ? (<svg aria-hidden="true" role="status" className="text-xl inline w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    </svg>) : <p className='text-bold'>Log in</p>
